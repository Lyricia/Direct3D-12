...
struct DefaultPos
{
	XMFLOAT3 pos[5] =
	{
		XMFLOAT3(945.0f * 4, 200.f, 1670.0f * 4),
		XMFLOAT3(500.0f * 4, 200.f, 666.f * 4),
		XMFLOAT3(398.0f * 4, 200.f, 1008.f * 4),
		XMFLOAT3(560.0f * 4, 200.f, 1518.f * 4),
		XMFLOAT3(1705.0f * 4, 200.f, 1140.f * 4)
	};
};
