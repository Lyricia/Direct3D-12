...
public:
	...
	CBillBoardVertex() {};
	CBillBoardVertex(XMFLOAT3 pos, XMFLOAT2 size) { m_xmf3Position = pos;  m_xmf2Size = size; }
	~CBillBoardVertex(){}
};
...
public:
	XMFLOAT3 m_xmf3Position;
	XMFLOAT2 m_xmf2Size;
	XMFLOAT2 m_xmf2SpritePos;

	CParticleBillBoardVertex() {};
	CParticleBillBoardVertex(XMFLOAT3 pos, XMFLOAT2 size, XMFLOAT2 SpritePos) { m_xmf3Position = pos;  m_xmf2Size = size; m_xmf2SpritePos = SpritePos; }
	~CParticleBillBoardVertex() {}
};
